    ...
    public function postRemoteData(){
         $response = RestCurl::post(
             'https://opay-api.oltranz.com/opay/paymentrequest',  [
                    'telephoneNumber' => '250786729197', // iyi ni number yumukiriya ugiye kwishyura
                    'amount' => "10.0", //cash agiye kwishyurwa
                    'organizationId' => '8a7481686a077f72016a0c94ea930001', // merchantId yacu
                    ...
                    'transactionId' => '000003', // iyi ni id transaction yacu ya payment
                ]);
      /*  "data" => {#444 ▼
      *      +"code": "200"
