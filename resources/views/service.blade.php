@extends('layouts.app')
	...
	<div class="container">
				...
				<div class="wrapper row">
					...
					<div class="details col-md-6">
						...
						<address>
							...
							Rwanda<br>
							KK 533 ST<br>
							<br title="Phone">Phone Number (House Owner):</br> +250 784 567 890
						</address>
		...
		<div class="row-fluid">
		        <div class="span8">
		        	<iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=-1.9456688,30.08397889999998&hl=en;z=14&amp;output=embed"></iframe>
		    	</div>
